#!/usr/bin/env python
# coding: utf-8
# CODE BY PIERRE - ADAPTED BY FERNANDO SANTOS
...
#Main goal of this adaptation: 
    # Create a script where I can run Infotopo directly in the server of the hospital, without any graphical output, and, togeter with Guilaumes code, as an output that is the list of triplets

# Which functions do I use here
# First =infotopo
server=True
###################################################################################
################             COMPUTE INFOPATH               #######################
